...
import tele_birr from "./Telebirr.png";
import awash from "./download.png";
...
export const products = [
  ...
  {
    _id: "buruk",
    name: "Futuristic Elegance: iPhone Design Masterpiece",
    description:
      "Sleek, futuristic iPhone with edge-to-edge display and polished finish.",
    price: 20000,
    dicount: 42,
    image: [p_img53],
    category: "Phone",
    subCategory: "iphone",
    sizes: ["1024x1024 pixels"],
    date: 1716668445448,
    bestseller: false,
  },
];
